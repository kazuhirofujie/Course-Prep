...
1. **アクセス確認（※重要※)**
   ...
   ご利用されるインターネットアクセスに制限がある場合、ラボ（演習）が実施できない場合がございます。
      ...
      1-1. 本研修ではSkillable社の演習環境を使用します。   
           以下手順をご参照の上、受講PC環境から演習環境にアクセスできることを事前にご確認ください。
...
3. **Microsoftアカウントの作成(※重要※)**
   ...
   （注：認定コースをご受講された実績を登録するために必要となります。  
        なお、演習で必要となるライセンスが付与されたアカウントは、弊社購入先の認定ラボにて別途取得いたします。）
...
5. **Microsoft Authenticator** **インストール手順**
